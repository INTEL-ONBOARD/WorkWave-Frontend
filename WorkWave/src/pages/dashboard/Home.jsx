...
<div className="min-h-screen bg-white p-4" style={{"margin-top":"3.5rem"}}>
      {/* Header */}
    ...
    <div class="flex flex-col w-full items-center">
        ...
        <p class="max-w-3xl mx-auto mt-10 text-lg text-center text-gray-700 md:text-xl">
            Enjoy reedom with Workwave. Get your work done in secounds.
        </p>
        ...
        <p class="mt-2 text-center text-gray-700 text-md md:text-sm">*Terms & Regulations applied</p>
    </div>
</section>
    ...
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 ">Default Taiwindcss Config</h1>
            ...
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 ">Fully Responsive Components</h1>
            ...
            <div>
                ...
                <h1 class="mt-4 text-xl font-semibold text-gray-800 ">RTL Languages Support</h1>
...
//         <img
//           src="https://cdn-icons.flaticon.com/png/512/2615/premium/2615926.png?token=exp=1628685662~hmac=a07c2b7cb0530f6b289f3044db1e3dc6"
//           alt="Students"
//           className="w-6 h-6"
//         />
//       </div>
...
//         <img
//           src="https://cdn-icons.flaticon.com/png/512/2615/premium/2615963.png?token=exp=1628685745~hmac=bc7d421ea2c58f797d4cfaf154aa94d1"
//           alt="Average Mark"
//           className="w-6 h-6"
//         />
//       </div>
...
//         <h3 className="text-xl font-bold">6.8</h3>
//       </div>
//     </div>
//   </div>
...
//         <img
//           src="https://cdn-icons.flaticon.com/png/512/2615/premium/2615983.png?token=exp=1628685816~hmac=1ad6dc4b79bc9c6a9c20c4b7ff320897"
//           alt="Underperforming Students"
//           className="w-6 h-6"
//         />
//       </div>
//       <div>
//         <p className="text-gray-600">Underperforming Students</p>
//         <h3 className="text-xl font-bold">9 (14%)</h3>
//       </div>
//     </div>
//   </div>
// </div>
...
//   {/* Chart */}
//   <div className="p-6 bg-white rounded-lg border  col-span-2">
...
//           />
//           <span className="font-medium">Annette Watson</span>
//         </div>
//         <span className="text-gray-600">9.3</span>
//       </li>
