...
const FormUpdate = ({ service }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.title || !formData.miniDescription || !formData.description || !formData.category || !formData.price || !formData.coverImage) {
    ...
    try {
      const response = await fetch('http://localhost:8083/api/ListService/update', {
        method: 'POST',
        body: formDataToSend,
      });
          ...
          <div className="rounded-lg w-full">
            <form className="w-full" onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                ...
                <textarea
                  id="description" // Match this ID with the state property
                  rows="4"
              ...
              <div className="mb-5">
                <label htmlFor="deliveryDays" className="block mb-2 text-sm font-medium text-gray-900">Delivery Days</label>
                <input
                  type="number"
                  id="deliveryDays"
